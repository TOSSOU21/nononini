            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/img-1.jpg' ; ?>" class="w-100" alt="About Us">
                    </div>
                </div>
                <div class="col-md-5">
            ...
            <div class="row justify-content-between align-items-center">                
                ...
                <div class="col-md-6">
                    <div class="img-wrapper">
                        ...
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/img-2.jpg'; ?>" class="w-100" alt="About Us">
                    </div>                      
                </div>
            </div><!-- End of Row -->           
        </div><!-- End of Container-->      
        ...
        <div class="container">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6">
                    <div class="img-wrapper">
                        <div class="after"></div>
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/img-3.jpg'; ?>" class="w-100" alt="About us">
                    </div>
                </div>
                <div class="col-md-5">
                    <h6 class="title mb-3">Lorem ipsum dolor sit amet, consectetur.</h6>
            ...
            <div class="row">
                <div class="col-sm-10 col-md-4 m-auto">
                    <div class="testmonial-wrapper">
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/avatar1.jpg'; ?>" alt="Client Image">
                ...
                <div class="col-sm-10 col-md-4 m-auto">
                    <div class="testmonial-wrapper">
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/avatar2.jpg'; ?>" alt="Client Image">
                ...
                <div class="col-sm-10 col-md-4 m-auto">
                    <div class="testmonial-wrapper">
                        <img src="<?php echo get_template_directory_uri().'/assets/imgs/avatar3.jpg'; ?>" alt="Client Image">
